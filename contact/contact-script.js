...
for (i = 0 ; i < inpu.length ; i++ ){
    ...
    inpu[i].onfocus = function (){
       this.setAttribute("class","border-attr"); 
       this.setAttribute("save-data",this.getAttribute('placeholder'));
       this.setAttribute("placeholder","");  
    } 

    inpu[i].onblur = function (){
        this.setAttribute("class","");
        this.setAttribute("placeholder",this.getAttribute('save-data'));
        this.setAttribute("save-data","");  
